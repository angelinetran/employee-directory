...
<table class="table table-hover mobile-hide">
  ...
  <tr>
    ...
    <th>Cell Phone</th>
    <th>Work Phone</th>
    <th><a class="btn btn-success btn-small pull-right" href="/new">Add Employee</a></th>
  </tr>
  </thead>
  <tbody>
  <tr ng-repeat="employee in employees | filter:search | orderBy:'name'">
    ...
    <td>
      <div class="pull-right">
        <a class="btn btn-primary btn-mini" href="/edit/{{employee.id}}">Edit</a>
        <button ng-click="destroy(employee)" class="btn btn-danger btn-mini">Delete</button>
      </div>
    </td>
  </tr>
  </tbody>
